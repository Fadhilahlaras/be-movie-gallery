...
public class ReportController {
    ...
    private void generateReport(List<Input> products) throws JRException{
        ...
        CustomJRDataSource<Input> dataSource = new CustomJRDataSource<Input>().using(products);
    ...
    public HttpEntity<byte[]> getReport() throws JRException,IOException {
        ...
        List<Input> products = inputRepository.findAll();
    ...
    private byte[] generateReportXlsx(List<Input> products) throws JRException, ReportException{
        logger.info("[!] Start generate report");
        // Path to our template goes here
        JasperReport jasperReport = JasperCompileManager.compileReport("src/main/resources/static/assets/jasper/report.jrxml");
        // load data to datasource
