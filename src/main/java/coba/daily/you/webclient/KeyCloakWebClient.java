package coba.daily.you.webclient;
...
import coba.daily.you.utils.KeyCloakUtil;
...
@Service
//Atur Akses Web dengan keycloak
public class KeyCloakWebClient {
    ...
    private WebClient client = WebClient.create("http://localhost:8080/auth/realms/daily/protocol/openid-connect");
...
//        if (status != HttpStatus.CREATED.value()) {
        ...
        //Ketika user pertama kali register, maka role realm yang diperoleh otomatis adalah app_user
